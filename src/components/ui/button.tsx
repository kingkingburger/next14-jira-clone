  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disable:to-neutral-100 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 disabled:text-muted-foreground border border-neutral-200 shadow-sm",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-white text-black hover:bg-neutral-100 hover:text-account-foreground",
